<?php include ROOT.'/views/layouts/header.php';?>
    ...
    <div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(/web/img/blog/<?= $productCategory[0]['category_picture']; ?>) no-repeat scroll center center / cover ;">
        <div class="ht__bradcaump__wrap">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <div class="bradcaump__inner text-center">
                            <h2 class="bradcaump-title" style="color: white"><?= $productCategory[0]['category_name']; ?></h2>
                            ...
                            <div class="product foo">
                                <div class="product__inner">
                                    ...
                                    <div class="product__hover__info">
                                        <ul class="product__action">
                                            ...
                                            <li><a title="Add TO Cart" href="/cart/add/<?= $item['id']?>"><span class="ti-shopping-cart"></span></a></li>
                                ...
                                <div class="product__details">
                                    ...
                                    <ul class="product__price">
                                        <li class="old__price"><?= $item['category_name']?></li>
