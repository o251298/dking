...
<!--                                    <img src="/web/img/product-details/small-img/1.jpg" alt="small-image">-->
<!--                                </a>-->
<!--                            </li>-->
<!--                            <li role="presentation" class="pot-small-img">-->
<!--                                <a href="#img-tab-2" role="tab" data-toggle="tab">-->
<!--                                    <img src="/web/img/product-details/small-img/2.jpg" alt="small-image">-->
<!--                                </a>-->
<!--                            </li>-->
<!--                            <li role="presentation" class="pot-small-img hidden-xs">-->
<!--                                <a href="#img-tab-3" role="tab" data-toggle="tab">-->
<!--                                    <img src="/web/img/product-details/small-img/3.jpg" alt="small-image">-->
<!--                                </a>-->
<!--                            </li>-->
                        ...
                        <div class="product__big__images">
                            <div class="portfolio-full-image tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane fade product-video-position" id="img-tab-2">
                                    <img src="/web/img/product-details/big-img/12.jpg" alt="full-image">
                                ...
                                <div role="tabpanel" class="tab-pane fade product-video-position" id="img-tab-3">
                                    <img src="/web/img/product-details/big-img/11.jpg" alt="full-image">
                                    <div class="product-video">
                                        <a class="video-popup" href="https://www.youtube.com/watch?v=cDDWvj_q-o8">
                                            <i class="zmdi zmdi-videocam"></i> View Video
                                        </a>
                ...
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 smt-30 xmt-30">
                    <div class="htc__product__details__inner">
                        ...
                        <ul class="pro__dtl__btn">
                            <li class="buy__now__btn"><a class="addToCart" data-id="<?=$item['id']?>" href="#">buy now</a></li>
...
<!--                                    <div class="review__thumb">-->
<!--                                        <img src="/web/img/review/2.jpg" alt="review images">-->
<!--                                    </div>-->
<!--                                    <div class="review__details">-->
<!--                                        <div class="review__info">-->
<!--                                            <h4><a href="#">Gerald Barnes</a></h4>-->
